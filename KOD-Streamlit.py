...
selected_year_start = st.sidebar.selectbox("poczatek",list(reversed(range(2001,2024))))
selected_year_end = st.sidebar.selectbox("koniec",list(reversed(range(2001,2024))))
